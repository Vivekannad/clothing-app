...
const About = () => {
  return (
    <section className='about pad-start flex justify-center items-center my-20'>
        <div className='container flex flex-col justify-center items-center w-1/2 gap-10'>
      <h2 className='text-7xl text-neutral-700 font-bold'>We love <span className='bg-blue-600 text-white p-2 rounded-2xl px-5'>Vkand</span>  </h2>
      <p>
